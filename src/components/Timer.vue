  ...
  <div class="timer">
    ...
    <div  class="timer__buttons">
      ...
      <div class="timer__button" @click="resumeTimer()">
        <svg fill="none" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg"><path d="m6 3.25c-1.51878 0-2.75 1.23122-2.75 2.75v12c0 1.5188 1.23122 2.75 2.75 2.75h12c1.5188 0 2.75-1.2312 2.75-2.75v-12c0-1.51878-1.2312-2.75-2.75-2.75z"/></svg>
      </div>
    </div>
  </div>
</template>
